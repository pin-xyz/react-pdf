...
function AnnotationLayer() {
    ...
    (0, utils_js_1.warning)(Number.parseInt(window
        .getComputedStyle(document.body)
        .getPropertyValue("--react-pdf-annotation-layer"), 10) === 1, "AnnotationLayer styles not found. Read more: https://github.com/wojtekmaj/react-pdf#support-for-annotations");
    ...
    function onLoadError() {
        ...
        (0, utils_js_1.warning)(false, annotationsError.toString());
    ...
    function onRenderError(error) {
        (0, utils_js_1.warning)(false, `${error}`);
