...
function TextLayer() {
    ...
    (0, utils_js_1.warning)(Number.parseInt(window
        ...
        .getPropertyValue("--react-pdf-text-layer"), 10) === 1, "TextLayer styles not found. Read more: https://github.com/wojtekmaj/react-pdf#support-for-text-layer");
    /**
    ...
    function onLoadError() {
        ...
        (0, utils_js_1.warning)(false, textContentError.toString());
        if (onGetTextError) {
    ...
    const onRenderError = (0, react_1.useCallback)((error) => {
        (0, utils_js_1.warning)(false, error.toString());
