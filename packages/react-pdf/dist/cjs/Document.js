...
const Document = (0, react_1.forwardRef)(function Document(_a, ref) {
    ...
    if (file && file !== prevFile.current && isParameterObject(file)) {
        (0, utils_js_1.warning)(!(0, dequal_1.dequal)(file, prevFile.current), `File prop passed to <Document /> changed, but it's equal to previous one. This might result in unnecessary reloads. Consider memoizing the value passed to "file" prop.`);
        prevFile.current = file;
    }
    // Detect non-memoized changes in options prop
    if (options && options !== prevOptions.current) {
        (0, utils_js_1.warning)(!(0, dequal_1.dequal)(options, prevOptions.current), `Options prop passed to <Document /> changed, but it's equal to previous one. This might result in unnecessary reloads. Consider memoizing the value passed to "options" prop.`);
    ...
    const viewer = (0, react_1.useRef)({
        ...
        scrollPageIntoView: (args) => {
            ...
            (0, utils_js_1.warning)(false, `An internal link leading to page ${pageNumber} was clicked, but neither <Document> was provided with onItemClick nor it was able to find the page within itself. Either provide onItemClick to <Document> and handle navigating by yourself or ensure that all pages are rendered within <Document>.`);
        },
    });
    ...
    function onSourceError() {
        ...
        (0, utils_js_1.warning)(false, sourceError.toString());
    ...
    function onLoadError() {
        ...
        (0, utils_js_1.warning)(false, pdfError.toString());
        if (onLoadErrorProps) {
